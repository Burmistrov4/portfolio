  ...
  return (
    ...
    >
      <Link href={`/projects/${project.id}`}>
        <Card className="h-full cursor-pointer flex flex-col border-2 border-transparent hover:border-primary transition-all duration-300 hover:shadow-2xl hover:shadow-primary/20 bg-card text-card-foreground">
          <CardHeader className="flex-shrink-0">
            ...
            {(imageError || !project.file_paths || project.file_paths.length === 0) && (
              <div className="relative w-full h-48 bg-gradient-to-br from-muted to-muted-foreground/20 rounded-t-lg flex items-center justify-center">
